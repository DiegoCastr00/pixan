            ...
            {navigationItems.map((item, index) => (
              <div key={item.name}>
                <div className="flex items-center justify-between">
                  <Link
                    href={item.href}
                    className="flex items-center space-x-3 text-gray-900 hover:text-emerald-600 hover:bg-emerald-50 transition-colors duration-200 py-3 px-3 rounded-lg flex-1"
                    ...
                    <div className="ml-12 mr-4 space-y-1 mt-2">
                      {item.dropdownItems?.map((dropdownItem) => (
                        <Link
                          ...
                          className="block text-gray-700 hover:text-emerald-600 hover:bg-emerald-50 transition-colors duration-200 py-2 px-3 rounded-lg"
                          onClick={onMenuClose}
                        >
                          {t(dropdownItem.name)}
                        </Link>
